...
namespace sokol
{
    ...
    public partial struct Rgb8U : IEquatable<Rgb8U>
    {
        ...
        public static bool operator ==(Rgb8U a, Rgb8U b) => a.Equals(b);
        ...
        public static bool operator !=(Rgb8U a, Rgb8U b) => !(a == b);
        ...
        /// <returns></returns>
        public static implicit operator Rgb8U(uint value) => new(value);
        ...
        /// <returns></returns>
        public static implicit operator Rgb8U(string value) => new(value);
        ...
        /// <inheritdoc />
        public bool Equals(Rgb8U other) => R == other.R && G == other.G && B == other.B;

        /// <inheritdoc />
        public override bool Equals(object? obj) => obj is Rgb8U other && Equals(other);
    }
}
