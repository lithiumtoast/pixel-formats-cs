...
namespace Sokol
{
    ...
    public partial struct Rgba8U : IEquatable<Rgba8U>
    {
        ...
        public static bool operator ==(Rgba8U a, Rgba8U b) => a.Equals(b);
        ...
        public static bool operator !=(Rgba8U a, Rgba8U b) => !(a == b);
        ...
        /// <returns></returns>
        public static implicit operator Rgba8U(uint value) => new(value);
        ...
        /// <returns></returns>
        public static implicit operator Rgba8U(string value) => new(value);
        ...
        /// <inheritdoc />
        public bool Equals(Rgba8U other) => R == other.R && G == other.G && B == other.B && A == other.A;

        /// <inheritdoc />
        public override bool Equals(object? obj) => obj is Rgba8U other && Equals(other);
    }
}
