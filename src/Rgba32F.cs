...
namespace Sokol
{
    ...
    public partial struct Rgba32F : IEquatable<Rgba32F>
    {
        ...
        public static bool operator ==(Rgba32F a, Rgba32F b) => a.Equals(b);
        ...
        public static bool operator !=(Rgba32F a, Rgba32F b) => !(a == b);
        ...
        /// <returns></returns>
        public static implicit operator Rgba32F(uint value) => new(value);
        ...
        /// <returns></returns>
        public static implicit operator Rgba32F(string value) => new(value);
        ...
        /// <param name="value">The <see cref="string" />.</param>
        /// <returns></returns>
        public static implicit operator Rgba32F(Vector4 value) => new(value);
        ...
        /// <inheritdoc />
        public bool Equals(Rgba32F other) => R.Equals(other.R) && G.Equals(other.G) && B.Equals(other.B) && A.Equals(other.A);

        /// <inheritdoc />
        public override bool Equals(object? obj) => obj is Rgba32F other && Equals(other);
    }
}
